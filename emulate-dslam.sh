...
ip addr add 212.64.109.1/24 dev eth0.22
...
ip addr add 212.64.110.1/24 dev eth0.27
...
ip link set eth0.27 up mtu 1492

ip route add 212.64.109.221 dev eth0.21
ip route add 212.64.109.241 dev eth0.22
ip route add 212.64.110.65 dev eth0.23
ip route add 212.64.110.124 dev eth0.24
ip route add 212.64.110.150 dev eth0.25
ip route add 212.64.110.173 dev eth0.26
ip route add 212.64.110.183 dev eth0.27
